...
# 读取核心知识库逻辑
def load_knowledge(file_path="knowledge.md"):
    try:
...
def get_rag_chain():
    ...
    # 初始化本地向量模型
    embeddings = HuggingFaceEmbeddings(model_name="BAAI/bge-small-zh-v1.5", cache_folder="./hf_cache")
    ...
    flashrank_client = Ranker(model_name="ms-marco-MiniLM-L-12-v2", cache_dir="./flashrank_models")
